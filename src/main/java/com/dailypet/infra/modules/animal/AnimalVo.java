...
public class AnimalVo{
	...
	private Integer shOptionGen;
	private Integer shOptionChip;
	private Integer shOptionVacc;
...
//		setThisPage(3);
	...
	public Integer getShOptionGen() {
		return shOptionGen;
	}

	public void setShOptionGen(Integer shOptionGen) {
		this.shOptionGen = shOptionGen;
	}

	public Integer getShOptionChip() {
		return shOptionChip;
	}

	public void setShOptionChip(Integer shOptionChip) {
		this.shOptionChip = shOptionChip;
	}

	public Integer getShOptionVacc() {
		return shOptionVacc;
	}

	public void setShOptionVacc(Integer shOptionVacc) {
		this.shOptionVacc = shOptionVacc;
	}
