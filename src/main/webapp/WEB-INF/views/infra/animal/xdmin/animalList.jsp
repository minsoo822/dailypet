...
<body>
	        ...
	        <div class="container">
	            <div class="row">
	                ...
	                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
	                    <div class="row">
	                    	<form method="post" name="amform">
						    <input type="hidden" name="ifamSeq">
												...
												<c:choose>
													...
													<c:otherwise>	
														<c:forEach items="${list}" var="list" varStatus="status">
															<tr onclick="goForm(${list.ifamSeq })" class="in">
																<td onClick="event.cancelBubble = true"><input class="form-check-input" type="checkbox" name="check" value="<c:out value="${list.ifamSeq }"/>"></td>
																<td>
																	<c:out value="${list.ifamSeq }"/>
																</td>
																<td>
																	<c:out value="${list.ifamName }"/>
																</td>
																<td>
																	<c:out value="${list.ifamAge }"/>
																</td>
																<td>
																	<c:choose>
																		<c:when test="${list.ifamGender eq 9 }">수컷</c:when>
																		<c:when test="${list.ifamGender eq 10 }">암컷</c:when>
																		<c:otherwise>중성화</c:otherwise>
																	</c:choose>
																</td>
																<td>
																	<c:out value="${list.ifamKind }"/>
																</td>
																<td>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="row" style="margin-top: 20px;">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="display: flex; justify-content: flex-end;">
										...
										<a href="/animal/animalForm"><button type="button" class="btn btn-primary" id="regbtn" style="margin-left: 5px;"><i class="fa-solid fa-plus"></i></button></a>
									</div>
								</div>
							</div>
	                    </div>
    ...
    <script type="text/javascript">
		...
		var ifamSeq = $("input:hidden[name=ifamSeq]");
