                       ...
                       <!--  <h3><b>기본 정보</b></h3> -->
                        ...
                        <div class="row div2 left">
							...
							<div class="col-lg-4 col-md-4 col-sm-4">
								<select class="form-select" name="ifcgUseNy">
							...
							<div class="col-lg-4 col-md-4 col-sm-4">
								<select class="form-select" name="ifcgDelNy">
									<option selected>::선택::</option>
						...
						<div class="row div2 left">
							<div class="col-lg-2 col-md-2 col-sm-2 gray">
								<label class="top4">코드그룹 이름(한글)</label>
							</div>
							<div class="col-lg-4 col-md-4 col-sm-4">
								<input class="form-control input" type="text" name="ifcgName" id="ifcgName" value="<c:out value="${item.ifcgName }"/>">
							</div>
							<div class="col-lg-2 col-md-2 col-sm-2 gray">
								<label class="top4">코드그룹 이름(영문)</label>
							</div>
							<div class="col-lg-4 col-md-4 col-sm-4">
								<input class="form-control input" type="text" name="ifcgName_eng" id="ifcgName_eng" value="<c:out value="${item.ifcgName_eng }"/>">
							</div>
						</div>
						<hr class="hr1">
						<br>
