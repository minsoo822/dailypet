                    ...
                    <div class="bg-light pinside30">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 left">
                                <h1>PW 찾기</h1>
                                <h5>비밀번호가 기억나지 않으신가요? 작성하신 이메일로 메일을 보내드립니다.</h5>
                                <br> 
                                <br>
                                <div class="row">
                                    <div class="col-md-11">
                                     ...
                                     <div class="col-md-11">
                                        <div class="form-group has-feedback">
                                            <label class="control-label" for="ifmmID">아이디</label>
                                            <div class="input-group"> <span class="input-group-addon"><div class="top font"><i class="fa-solid fa-id-badge"></i></div></span>
                                                <input type="text" class="form-control" id="ifmmID" placeholder="아이디 입력">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-11">
