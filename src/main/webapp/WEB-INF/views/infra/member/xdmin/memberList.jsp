												...
												<c:choose>
													...
													<c:otherwise>	
														<c:forEach items="${list}" var="list" varStatus="status">
															<tr onclick="goForm(${list.ifmmSeq })" class="in">
																<td onClick="event.cancelBubble = true"><input class="form-check-input" type="checkbox" name="check" value="<c:out value="${list.ifmmSeq }"/>"></td>
																<td>
																...
																<td>
																	<c:out value="${list.ifmmAddr1 }"/>
																</td>
																<td>
																	<c:out value="${list.ifmmTel }"/>
																</td>
																<td>
																	<c:out value="${list.ifmmEmail }"/>
																</td>
																<td>
																	<c:out value="${list.ifmmRegDate }"/>
																</td>
																<td id="DelNY">
																	<c:choose>
																		<c:when test="${list.ifmmDelNy eq 0 }">N</c:when>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="row" style="margin-top: 20px;">
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="display: flex; justify-content: flex-end;">
										...
										<a href="/member/memberForm"><button type="button" class="btn btn-primary" id="regbtn" style="margin-left: 5px;"><i class="fa-solid fa-plus"></i></button></a>
									</div>
								</div>
							</div>
	                    </div>
